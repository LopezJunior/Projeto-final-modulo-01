...
console.log(`Você ira participar de jogos com seu time, se conseguir ganhar 5 você tera uma vaga para o campeonato dos CAMPEOES`)
console.log()
console.log(`Sua mãe lhe permitiu a todas as tardes, então logo depois do almoço consegu-ra jogar...`)
